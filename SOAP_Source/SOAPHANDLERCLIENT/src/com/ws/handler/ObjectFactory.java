 ...
 * generated in the com.ws.handler package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://handler.ws.com/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://handler.ws.com/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.handler
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.ws.com/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.ws.com/", name = "getServerNameResponse")
