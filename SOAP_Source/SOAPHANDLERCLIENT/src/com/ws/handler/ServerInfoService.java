 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://handler.ws.com/", wsdlLocation = "http://localhost:8888/ws/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://handler.ws.com/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://handler.ws.com/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://handler.ws.com/", "ServerInfoPort"), ServerInfo.class, features);
    }
